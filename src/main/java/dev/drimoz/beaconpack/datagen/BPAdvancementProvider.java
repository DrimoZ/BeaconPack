...
import dev.drimoz.beaconpack.registry.BPTags;
...
public class BPAdvancementProvider implements AdvancementProvider.AdvancementGenerator {
    ...
    private static Component title(String name) {
        return Component.translatable("advancement." + BeaconPack.MOD_ID + "." + name + ".title");
    }

    private static Component description(String name) {
        return Component.translatable("advancement." + BeaconPack.MOD_ID + "." + name + ".description");
    }

    private static ResourceLocation id(String name) {
        return ResourceLocation.fromNamespaceAndPath(BeaconPack.MOD_ID, name);
    }
}
